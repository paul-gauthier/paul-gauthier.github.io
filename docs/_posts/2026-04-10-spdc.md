...
The original photon's energy is split between two photons
...
That way you'll pick up both members of each pair,
which are often referred to as the *signal* and *idler* photons.
...
The interactive demo above contains simplified versions of all these key
components.
